...
"$LINUX_ROOT/scripts/sign-file" sha512 "$LINUX_ROOT/certs/signing_key.pem" "$LINUX_ROOT/certs/signing_key.x509" "$SRC_KVM"
"$LINUX_ROOT/scripts/sign-file" sha512 "$LINUX_ROOT/certs/signing_key.pem" "$LINUX_ROOT/certs/signing_key.x509" "$SRC_INTEL"
